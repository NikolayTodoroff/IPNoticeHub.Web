...
namespace IPNoticeHub.Data.Migrations
{
    ...
    [Migration("20250927142006_WatchlistEntityCreated")]
    partial class WatchlistEntityCreated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IPNoticeHub.Data.Entities.Identity.UserCopyright", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateAdded = new DateTime(2025, 9, 27, 14, 20, 5, 572, DateTimeKind.Utc).AddTicks(9296),
                            IsDeleted = false
                        });
                });
