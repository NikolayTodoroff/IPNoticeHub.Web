...
namespace IPNoticeHub.Data.Repositories.Application.Abstractions
{
    ...
    {
        Task AddOrUndeleteAsync(string userId, int trademarkId, string currentStatusCode, CancellationToken cancellationToken);
        ...
        Task<bool> ExistsAsync(string userId, int trademarkId, CancellationToken cancellationTokent);
