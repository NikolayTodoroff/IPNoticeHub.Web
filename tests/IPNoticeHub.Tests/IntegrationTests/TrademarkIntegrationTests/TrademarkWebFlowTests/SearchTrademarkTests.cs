...
namespace IPNoticeHub.Tests.IntegrationTests.TrademarkIntegrationTests.TrademarkWebFlowTests
{
    ...
    public class SearchTrademarkTests
    {
        ...
        [Test]
        public async Task Get_TrademarkSearch_WithoutSearchTerm_ReturnsSuccess()
        {
        ...
        [Test]
        public async Task Get_TrademarkSearch_WithSearchTerm_Returns200()
        {
            ...
            var response = 
                await client.GetAsync("/Home?SearchTerm=AAA");

            response.StatusCode.Should().Be(HttpStatusCode.OK);
        }

        [Test]
        public async Task Get_TrademarkSearch_WithSearch_PagingAndSorting_Returns200()
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = 
            ...
            var response = await client.GetAsync("/Home?SearchTerm=Starstruck&sortBy=WordmarkAsc&currentPage=2&resultsPerPage=1");

            response.StatusCode.Should().Be(HttpStatusCode.OK);
        }

        [Test]
        public async Task Get_TrademarkSearch_WithNoResults_Returns200()
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
            ...
            var response = await client.GetAsync("/Home?SearchTerm=ZZZ");

            response.StatusCode.Should().Be(HttpStatusCode.OK);
        }

        [Test]
        public async Task Get_TrademarkSearch_WithOutOfRangePaging_Returns200()
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = serviceScope.ServiceProvider.GetRequiredService<IPNoticeHubDbContext>();
            ...
            var response = await client.GetAsync("/Home?SearchTerm=AAA100&sortBy=WordmarkAsc&currentPage=9999&resultsPerPage=9999");

            response.StatusCode.Should().Be(HttpStatusCode.OK);
        }

        [Test]
        public async Task Get_TrademarkSearch_WithInvalidSortBy_Returns200()
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = serviceScope.ServiceProvider.GetRequiredService<IPNoticeHubDbContext>();
            ...
            var response = await client.GetAsync("/Home?SearchTerm=D100&sortBy=TotallyNotAValue&currentPage=1&resultsPerPage=10");
        ...
        [TestCase(0)]
        [TestCase(-5)]
        public async Task Get_TrademarkSearch_WhenResultsPerPage_NonPositive_Returns200(int resultsPerPage)
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = serviceScope.ServiceProvider.GetRequiredService<IPNoticeHubDbContext>();
            ...
            var url = $"/Home?SearchTerm=ALPHA&sortBy=WordmarkAsc&currentPage=1&resultsPerPage={resultsPerPage}";
        ...
        [TestCase(5000)]
        [TestCase(10000)]
        public async Task Get_TrademarkSearch_WhenResultsPerPage_VeryLarge_Returns200(int resultsPerPage)
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = serviceScope.ServiceProvider.GetRequiredService<IPNoticeHubDbContext>();
        ...
        public async Task Get_TrademarkSearch_SortBy_RegistrationDateVariants_Returns200(string sortBy)
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = 
                ...
                testDbContext.TrademarkRegistrations.AddRange(
                    initianEntity,newEntity,noRegDateEntity);
            ...
            var url = $"/Home?SearchTerm=E&sortBy={sortBy}&currentPage=1&resultsPerPage=10";
            var response = await client.GetAsync(url);
        ...
        [Test]
        public async Task Get_TrademarkSearch_WhitespaceSearchTerm_Returns200()
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = 
            ...
            var response = await client.GetAsync(
                "/Home?SearchTerm=%20%20%20");

            response.StatusCode.Should().Be(HttpStatusCode.OK);
        }

        [Test]
        public async Task Get_TrademarkSearch_LargeDataset_Paging_Returns200()
        {
            using (var serviceScope = appFactory.Services.CreateScope())
            {
                var testDbContext = 
            ...
            var response = await client.GetAsync("/Home?SearchTerm=BULK&sortBy=WordmarkAsc&currentPage=3&resultsPerPage=25");
